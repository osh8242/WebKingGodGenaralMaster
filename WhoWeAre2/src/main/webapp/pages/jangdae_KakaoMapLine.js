var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = {
        center: new kakao.maps.LatLng(37.582584, 127.001607), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
